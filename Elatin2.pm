...
=item Make character
  ...
  set. For example, Elatin2::chr(65) is "A" in either ASCII or Latin-2, not Unicode,
  and Elatin2::chr(0x82a0) is a Latin-2 HIRAGANA LETTER A. For the reverse of
  Elatin2::chr, use Latin2::ord.
