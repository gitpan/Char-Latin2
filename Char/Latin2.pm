...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Elatin2::function_ord     = 'Char::Latin2::ord'     if /\A ord \z/oxms;
                    $Char::Elatin2::function_ord_    = 'Char::Latin2::ord_'    if /\A ord \z/oxms;
                    $Char::Elatin2::function_reverse = 'Char::Latin2::reverse' if /\A reverse \z/oxms;
                    $Char::Elatin2::function_getc    = 'Char::Latin2::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::Latin2::escape();
...
=head1 Calling 'Char::Elatin2::ignorecase()' (Char::Latin2 software provides)

Char::Latin2 software applies calling 'Char::Elatin2::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::Latin2 software provides)

Char::Latin2 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::Latin2 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::Latin2 software provides)

Char::Latin2 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin2 software and
