...
#
package Char::Elatin2;
######################################################################
#
# Char::Elatin2 - Run-time routines for Char/Latin2.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Elatin2::index($name, '::') == -1) && (Char::Elatin2::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Elatin2::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Elatin2::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Elatin2::split(;$$$);
sub Char::Elatin2::tr($$$$;$);
sub Char::Elatin2::chop(@);
sub Char::Elatin2::index($$;$);
sub Char::Elatin2::rindex($$;$);
sub Char::Elatin2::lcfirst(@);
sub Char::Elatin2::lcfirst_();
sub Char::Elatin2::lc(@);
sub Char::Elatin2::lc_();
sub Char::Elatin2::ucfirst(@);
sub Char::Elatin2::ucfirst_();
sub Char::Elatin2::uc(@);
sub Char::Elatin2::uc_();
sub Char::Elatin2::fc(@);
sub Char::Elatin2::fc_();
sub Char::Elatin2::ignorecase;
sub Char::Elatin2::classic_character_class;
sub Char::Elatin2::capture;
sub Char::Elatin2::chr(;$);
sub Char::Elatin2::chr_();
sub Char::Elatin2::glob($);
sub Char::Elatin2::glob_();

sub Char::Latin2::ord(;$);
sub Char::Latin2::ord_();
sub Char::Latin2::reverse(@);
sub Char::Latin2::getc(;*@);
sub Char::Latin2::length(;$);
sub Char::Latin2::substr($$;$$);
sub Char::Latin2::index($$;$);
sub Char::Latin2::rindex($$;$);
sub Char::Latin2::escape(;$);
...
${Char::Elatin2::dot}         = qr{(?:[^\x0A])};
${Char::Elatin2::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Elatin2::eD}          = qr{(?:[^0-9])};
...
# ${Char::Elatin2::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Elatin2::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Elatin2::eS}          = qr{(?:[^\s])};

${Char::Elatin2::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Elatin2::eH}          = qr{(?:[^\x09\x20])};
${Char::Elatin2::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Elatin2::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Elatin2::eN}          = qr{(?:[^\x0A])};
${Char::Elatin2::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Elatin2::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Elatin2::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Elatin2::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Elatin2::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Elatin2::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Elatin2::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Elatin2::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Elatin2::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin2::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Elatin2::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Elatin2::not_space}   = qr{(?:[^\s\x0B])};
${Char::Elatin2::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Elatin2::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Elatin2::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Elatin2::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Elatin2::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Elatin2::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Elatin2::foo" used only once: possible typo at here.
${Char::Elatin2::dot}         = ${Char::Elatin2::dot};
${Char::Elatin2::dot_s}       = ${Char::Elatin2::dot_s};
${Char::Elatin2::eD}          = ${Char::Elatin2::eD};
${Char::Elatin2::eS}          = ${Char::Elatin2::eS};
${Char::Elatin2::eW}          = ${Char::Elatin2::eW};
${Char::Elatin2::eH}          = ${Char::Elatin2::eH};
${Char::Elatin2::eV}          = ${Char::Elatin2::eV};
${Char::Elatin2::eR}          = ${Char::Elatin2::eR};
${Char::Elatin2::eN}          = ${Char::Elatin2::eN};
${Char::Elatin2::not_alnum}   = ${Char::Elatin2::not_alnum};
${Char::Elatin2::not_alpha}   = ${Char::Elatin2::not_alpha};
${Char::Elatin2::not_ascii}   = ${Char::Elatin2::not_ascii};
${Char::Elatin2::not_blank}   = ${Char::Elatin2::not_blank};
${Char::Elatin2::not_cntrl}   = ${Char::Elatin2::not_cntrl};
${Char::Elatin2::not_digit}   = ${Char::Elatin2::not_digit};
${Char::Elatin2::not_graph}   = ${Char::Elatin2::not_graph};
${Char::Elatin2::not_lower}   = ${Char::Elatin2::not_lower};
${Char::Elatin2::not_lower_i} = ${Char::Elatin2::not_lower_i};
${Char::Elatin2::not_print}   = ${Char::Elatin2::not_print};
${Char::Elatin2::not_punct}   = ${Char::Elatin2::not_punct};
${Char::Elatin2::not_space}   = ${Char::Elatin2::not_space};
${Char::Elatin2::not_upper}   = ${Char::Elatin2::not_upper};
${Char::Elatin2::not_upper_i} = ${Char::Elatin2::not_upper_i};
${Char::Elatin2::not_word}    = ${Char::Elatin2::not_word};
${Char::Elatin2::not_xdigit}  = ${Char::Elatin2::not_xdigit};
${Char::Elatin2::eb}          = ${Char::Elatin2::eb};
${Char::Elatin2::eB}          = ${Char::Elatin2::eB};
...
sub Char::Elatin2::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin2::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin2::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin2::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Elatin2::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Elatin2::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Elatin2::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Elatin2::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Elatin2::uc($char[$i]);
                my $fc = Char::Elatin2::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Elatin2::not_lower_i}',
                '[:^upper:]'  => '${Char::Elatin2::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Elatin2::not_alnum}',
                '[:^alpha:]'  => '${Char::Elatin2::not_alpha}',
                '[:^ascii:]'  => '${Char::Elatin2::not_ascii}',
                '[:^blank:]'  => '${Char::Elatin2::not_blank}',
                '[:^cntrl:]'  => '${Char::Elatin2::not_cntrl}',
                '[:^digit:]'  => '${Char::Elatin2::not_digit}',
                '[:^graph:]'  => '${Char::Elatin2::not_graph}',
                '[:^lower:]'  => '${Char::Elatin2::not_lower}',
                '[:^print:]'  => '${Char::Elatin2::not_print}',
                '[:^punct:]'  => '${Char::Elatin2::not_punct}',
                '[:^space:]'  => '${Char::Elatin2::not_space}',
                '[:^upper:]'  => '${Char::Elatin2::not_upper}',
                '[:^word:]'   => '${Char::Elatin2::not_word}',
                '[:^xdigit:]' => '${Char::Elatin2::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Elatin2::uc($char);
                        my $fc = Char::Elatin2::fc($char);
                        if ($uc eq $fc) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Elatin2::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Elatin2::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Elatin2::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Elatin2::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub Char::Latin2::getc(;*@) {
    ...
    croak 'Too many arguments for Char::Latin2::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Elatin2::dot_s} \z/oxms) {
...
sub Char::Latin2::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Elatin2::index($_[0], $_[1], CORE::length(Char::Latin2::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Elatin2::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::Latin2::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::Latin2::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Elatin2::rindex($_[0], $_[1], CORE::length(Char::Latin2::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Elatin2::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::Latin2::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::Latin2::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::Latin2::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::Latin2::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin2::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin2::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin2::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin2::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin2::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Elatin2::POSTMATCH()};
    }
...
# subroutines of package Char::Elatin2
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::Latin2::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::Latin2::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::Latin2::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin2::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::Latin2::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin2::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin2::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::Latin2::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Latin2::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Elatin2::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Elatin2::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Elatin2::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin2::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Elatin2::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Elatin2::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Elatin2::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Elatin2::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Elatin2::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Elatin2::PREMATCH()]}
            ...
            $e_string .= q{Char::Elatin2::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Elatin2::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Elatin2::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Elatin2::POSTMATCH()]}
            ...
            $e_string .= q{Char::Elatin2::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Elatin2
        ...
        elsif ($string =~ /\G \b Char::Latin2::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin2::eval \b                                /oxgc) { $e_string .= 'eval Char::Latin2::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Elatin2::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin2::index \b                               /oxgc) { $e_string .= 'Char::Latin2::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Elatin2::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::Latin2::rindex \b                              /oxgc) { $e_string .= 'Char::Latin2::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Elatin2::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Elatin2::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Elatin2::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin2::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Elatin2::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Elatin2::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Elatin2::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Elatin2::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Elatin2::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Elatin2::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Elatin2::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Elatin2::dot_s}';
        }
        else {
            return '${Char::Elatin2::dot}';
        }
    }
    else {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin2::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Elatin2::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Elatin2::uc($char[$i]) ne Char::Elatin2::fc($char[$i]))) {
            if (CORE::length(Char::Elatin2::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Elatin2::uc($char[$i])       . Char::Elatin2::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Elatin2::uc($char[$i]) . '|' . Char::Elatin2::fc($char[$i]) . ')';
            }
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Elatin2::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin2::ignorecase(Char::Elatin2::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin2::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Elatin2::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin2::ignorecase(Char::Elatin2::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin2::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Elatin2::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Elatin2::ignorecase(Char::Elatin2::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Elatin2::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::Latin2::re_t=%s; while($Char::Latin2::re_t =~ %s){%s local $^W=0; local $Char::Latin2::re_r=%s; %s$Char::Latin2::re_t="$`$Char::Latin2::re_r$'"; pos($Char::Latin2::re_t)=length "$`$Char::Latin2::re_r"; } return $Char::Latin2::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::Latin2::re_r=CORE::eval $Char::Latin2::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::Latin2::re_r=%s; %s"%s$Char::Latin2::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::Latin2::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::Latin2::re_r=%s; %s%s="$`$Char::Latin2::re_r$'"; pos(%s)=length "$`$Char::Latin2::re_r"; $Char::Latin2::re_n++} return %s$Char::Latin2::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::Latin2::re_r=%s; %s%s="%s$Char::Latin2::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::Latin2::re_r=%s; %s%s="%s$Char::Latin2::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::Latin2::re_r=CORE::eval $Char::Latin2::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Elatin2::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Elatin2::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Elatin2;
    ...
    Char::Elatin2::lc(...);
    Char::Elatin2::lc_;
    Char::Elatin2::lcfirst(...);
    Char::Elatin2::lcfirst_;
    Char::Elatin2::uc(...);
    Char::Elatin2::uc_;
    Char::Elatin2::ucfirst(...);
    Char::Elatin2::ucfirst_;
    Char::Elatin2::fc(...);
    Char::Elatin2::fc_;
    Char::Elatin2::ignorecase(...);
    Char::Elatin2::capture(...);
    Char::Elatin2::chr(...);
    Char::Elatin2::chr_;
    Char::Elatin2::glob(...);
    Char::Elatin2::glob_;

  # "no Char::Elatin2;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::Latin2 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::Latin2 software and not
...
This Char::Elatin2 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Elatin2::split(/pattern/,$string,$limit);
  @split = Char::Elatin2::split(/pattern/,$string);
  @split = Char::Elatin2::split(/pattern/);
  @split = Char::Elatin2::split('',$string,$limit);
  @split = Char::Elatin2::split('',$string);
  @split = Char::Elatin2::split('');
  @split = Char::Elatin2::split();
  @split = Char::Elatin2::split;
  ...
  at all, Char::Elatin2::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Elatin2::split(//,  $word);
  @fields = Char::Elatin2::split(/:/, $line);
  @words  = Char::Elatin2::split(" ", $paragraph);
  @lines  = Char::Elatin2::split(/^/, $buffer);
  ...
  print join(":" => Char::Elatin2::split(/ */, "hi there"));
  ...
  Char::Elatin2::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Elatin2::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Elatin2::split with no arguments does. Thus,
  Char::Elatin2::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Elatin2::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Elatin2::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Elatin2::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Elatin2::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Elatin2::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Elatin2::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Elatin2::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Elatin2::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Elatin2::chop(@list);
  $chop = Char::Elatin2::chop();
  $chop = Char::Elatin2::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Elatin2::chop subroutine is used primary to remove the newline
  ...
  since Char::Elatin2::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Elatin2::chop a literal, only a variable. If you Char::Elatin2::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Elatin2::chop(@lines);

  You can Char::Elatin2::chop anything that is an lvalue, including an assignment:

  Char::Elatin2::chop($cwd = `pwd`);
  Char::Elatin2::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Elatin2::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Elatin2::chop returns the character
  ...
  In the most general case, Char::Elatin2::chop can be expressed using substr:

  $last_code = Char::Elatin2::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Elatin2::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Elatin2::chop;
...
=item Index string
  ...
  $byte_pos = Char::Elatin2::index($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin2::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Elatin2::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Elatin2::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Elatin2::rindex($string,$substr);

  This subroutine works just like Char::Elatin2::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Elatin2::index).
  ...
  while (($byte_pos = Char::Latin2::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Elatin2::fc subroutine for case-insensitive comparisons via Char::Latin2
  software.

=item Lower case first character of string

  $lcfirst = Char::Elatin2::lcfirst($string);
  $lcfirst = Char::Elatin2::lcfirst_;
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Elatin2::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Elatin2::ucfirst($string);
  $ucfirst = Char::Elatin2::ucfirst_;
  ...
  $titlecase = Char::Elatin2::ucfirst(substr($word,0,1)) . Char::Elatin2::lc(substr($word,1));
  ...
  $do_not_use = Char::Elatin2::ucfirst(Char::Elatin2::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Elatin2::fc($string);
  $fc = Char::Elatin2::fc_;

  New to Char::Latin2 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Elatin2::fc($a) eq Char::Elatin2::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::Latin2 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Elatin2::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Elatin2::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Elatin2::chr($code);
  $chr = Char::Elatin2::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Elatin2::chr(65) is "A" in either
  ASCII or Latin-2, not Unicode. For the reverse of Char::Elatin2::chr, use Char::Latin2::ord.

=item Filename expansion (globbing)

  @glob = Char::Elatin2::glob($string);
  @glob = Char::Elatin2::glob_;
  ...
  The Char::Elatin2::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Elatin2::glob('"*e f*"');
  @spacies = Char::Elatin2::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Elatin2::glob("'*${var}e f*'");
  @spacies = Char::Elatin2::glob(qq("*${var}e f*"));
